                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('admin.updateProduct', ['id' => $id]) }}" method="POST"  enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3 mt-3">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="regular_price" class="form-control"
                                            placeholder="Enter Regular Price" value="{{$product->regular_price}}" required />
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="sku" class="form-control" placeholder="Enter SKU" value="{{$product->sku}}"/>
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <img id="image-preview" src="{{ asset('assets/imgs/products') }}/{{ $product->image }}" class="mt-20" alt="Preview"
