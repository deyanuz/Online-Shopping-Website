                            ...
                            <div class="row">
                                    ...
                                    <article class="first-post mb-30 wow fadeIn animated hover-up">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <h2 class="post-title mb-20">
                                                <a href="blog-details.html">{{$articles['0']['title']}}</a>
                                            </h2>
                                            <p class="post-exerpt font-medium text-muted mb-30">{{$articles['0']['description']}}</p>
                                            <div class="mb-20 entry-meta meta-2">
                                                <div class="font-xs ">
                                                    <span class="post-by">By <a href="blog.html">{{$articles['0']['author']}}</a></span>
                                                    <span class="post-on">{{$articles['0']['publishedAt']}}</span>
                                                    <div class="source mt-5">Source:<a target="blank" href="https://{{$articles['0']['source']['name']}}"> {{$articles['0']['source']['name']}}</a></div>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            ...
                                            <p class="post-exerpt mb-30">These people envy me for having a lifestyle they
                                                don’t have, but the truth is, sometimes I envy their lifestyle instead.
                                                Struggling to sell one multi.</p>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="blog-details.html">Essential Qualities of Highly Successful
                                                    Music</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">Graduating from a top accelerator or incubator can
                                                be as career-defining for a startup founder as an elite university diploma.
                                    ...
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            ...
                                            <p class="post-exerpt mb-30">At the Emmys, broadcast scripted shows created by
                                                people of color gained ground relative to those pitched by White show
                                                creators, while broadcast scripted shows.</p>
                                            <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                                <div>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            ...
                                            <p class="post-exerpt mb-30">We live in a world where disruption and dynamism
                                                reign supreme and businesses must be ready to adapt to the many
                                                unpredictable changes that come with this.</p>
                                            <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on"> <i class="fi-rs-clock"></i> 25 April
                                                        2022</span>
                                ...
                                <div class="row">
                                    <div class="col-12 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h4 class="post-title mb-10 text-limit-2-row">The litigants on the screen are
                                                not actors </h4>
