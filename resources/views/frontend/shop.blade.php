                ...
                <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="assets/imgs/shop/product-1-2.jpg"
                                                    alt="">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href={{ route('frontend.shop') }}>Shoes & Bags</a></li>
                                <li><a href={{ route('frontend.shop') }}>Blouses & Shirts</a></li>
                                <li><a href={{ route('frontend.shop') }}>Dresses</a></li>
                                <li><a href={{ route('frontend.shop') }}>Swimwear</a></li>
                                <li><a href={{ route('frontend.shop') }}>Beauty</a></li>
                                <li><a href={{ route('frontend.shop') }}>Jewelry & Watch</a></li>
                                <li><a href={{ route('frontend.shop') }}>Accessories</a></li>
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
