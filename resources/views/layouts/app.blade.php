                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Get great devices up to 50% off <a href={{route('frontend.shop')}}>View details</a></li>
                                    <li>Supper Value Deals - Save more with coupons</li>
                                    <li>Trendy 25silver jewelry, save up 35% off today <a href={{route('frontend.shop')}}>Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <li><i class="fi-rs-key"></i><a href={{route('auth.login')}}>Log In </a>  / <a href={{route('auth.register')}}>Sign Up</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href={{route('frontend.shop')}}><i class="surfsidemedia-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href={{route('frontend.shop')}}><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        <a href={{route('frontend.shop')}}><i class="surfsidemedia-font-smartphone"></i> Cellphones</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-desktop"></i>Computer & Office</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-diamond"></i>Jewelry & Accessories</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-teddy-bear"></i>Mother & Kids</a></li>
                                    <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-kite"></i>Outdoor fun</a></li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-desktop"></i>Beauty, Health</a></li>
                                            <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-cpu"></i>Bags and Shoes</a></li>
                                            <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-diamond"></i>Consumer Electronics</a></li>
                                            <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-home"></i>Automobiles & Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-dress"></i>Women's Clothing</a></li>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a></li>
                                <li> <a href={{route('frontend.shop')}}><i class="surfsidemedia-font-smartphone"></i> Cellphones</a></li>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-desktop"></i>Computer & Office</a></li>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a></li>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
                                <li><a href={{route('frontend.shop')}}><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href={{route('frontend.shop')}}>shop</a></li>
